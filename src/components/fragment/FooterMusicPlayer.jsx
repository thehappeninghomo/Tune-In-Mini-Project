    ...
    return (
        <div  className={"footer-player"}>
            ...
            <div className="playback-controls">
                ...
                <ControlsToggleButton style={{color:"#055052"}} type={"repeat"}
                                      defaultIcon={<RepeatIcon fontSize={"large"}/>}
                                      changeIcon={<RepeatOneIcon fontSize={"large"}/>}
                                      onClicked={handleToggle}/>

                <ControlsToggleButton style={{color:"#055052"}} type={"prev"}
                ...
                <ControlsToggleButton style={{color:"#055052"}} type={"play-pause"}
                                      defaultIcon={<PlayArrowIcon fontSize={"large"}/>}
                                      changeIcon={<PauseIcon fontSize={"large"}/>}
                                      onClicked={handleToggle}/>


                <ControlsToggleButton style={{color:"#055052"}} type={"next"}
            ...
            <div className="playback-widgets">
                ...
                <div className={"slider"}>
                    <Slider style={{color:"#055052"}} value={volume} onChange={handleVolumeChange}/>
                </div>
                <ControlsToggleButton style={{color:"#055052"}} type={"volume"}
